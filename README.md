# [Проект: "Фильмография"](https://filmography-alpha.vercel.app/)
...
### Перед запуском
```
Добавить .env с переменными окружения для работы с api. Как пример файл .env.example
```
...
### Деплой проекта в gh-pages (опционально):
